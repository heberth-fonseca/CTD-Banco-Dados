...
SELECT clientes.nome, faturas.valor_total FROM clientes
...
SELECT cancoes.id as 'ID da Música', cancoes.nome as 'Nome da Música', tipos_de_arquivo.nome as 'Tipo de arquivo' FROM tipos_de_arquivo
INNER JOIN cancoes ON tipos_de_arquivo.id = cancoes.id_tipo_de_arquivo
ORDER BY cancoes.id;